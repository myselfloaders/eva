...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('Owner', url='https://t.me/Free_Loaders')
            ],
            [
                InlineKeyboardButton('Halp', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('Halp', callback_data='help'),
